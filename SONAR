...
def drawBoard(board):
    ...
    # Print the numbers aross the top of the board.
    ...
    # Print the numbers aross the bottom of the board.
    print()
    print('   ' + ('0123456789' * 6 ))
    print(tensDigitsLine)
...
is to use sonar to find three sunken treasure chests at the bottom of
